...
import { Camera, Upload, Save, X, User } from "lucide-react"
...
const ProfilePictureUpload: React.FC<ProfilePictureUploadProps> = ({
  ...
  // For anonymous profiles, show a generic user icon instead of initials
  const shouldShowGenericIcon = isAnonymous && !currentImage
      ...
      <div className="relative group">
        <Avatar className="h-48 w-48 border-4 border-white shadow-lg">
          <AvatarImage
            src={currentImage}
            alt={userName}
            style={isAnonymous ? { filter: "blur(8px)" } : undefined}
          />
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-gray-600 text-center">
              Drag to reposition and resize your photo. The image will be
              cropped to a circle.
            </div>
          </div>
